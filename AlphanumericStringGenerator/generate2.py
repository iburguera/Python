...
def menu():
	...
	print "-"*60
	print "Use: python generate2.py <number_of_strings> <length_of_string> <menu_option>"
	print " "
	print "OPTIONS:"
	print "	# 0 - Digits"
	print "	# 1 - Lowercase"
	...
	print " "
	print "Example: Generate  4 strings of 5 length Digits+Uppercase(3) string " 
	print ">>>"
	print ">>> python generate2.py 4 5 3"
	print ">>> 76XZE"
	print ">>> TAD5I"
	print ">>> R8HQN"
	print ">>> CYPZF"
